...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('doctors', function (Blueprint $table) {
            ...
            // Kasbiy ma'lumotlar
            $table->string('specialization')->nullable();       // Mutaxassisligi
            ...
            // Statistikalar (ixtiyoriy, alohida hisoblanadi)
            $table->integer('today_patients')->default(0);
            ...
            $table->text('bio')->nullable();           // Shifokor haqida ma’lumot
            $table->enum('status', ['active', 'inactive', 'on_leave'])->default('inactive');
            $table->string('photo')->nullable();
        
            // Sertifikatlar uchun alohida jadval bo‘ladi (doctor_certificates)
            $table->timestamps();
        });
    }
