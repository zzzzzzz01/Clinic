<x-layouts.main.app>
    <x-slot:title>
        @lang('words.login_to_system')
    </x-slot:title>

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">

    <!-- Contact Start -->
    <div class="container-fluid min-vh-100 contact pt-4 pb-2">
        <div class="container py-5">
            <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
            </div>
            <div class="row g-4 justify-content-center align-items-center" style="margin-top: 120px;">
                <div class="col-lg-6 col-xl-6 contact-form wow fadeInLeft" data-wow-delay="0.1s">
                    <h2 class="display-5 text-white mb-2 text-center">@lang('words.login_to_system')</h2>
                    <form action="{{ route('authanticate') }}" method="POST" id="loginForm">
                    @csrf
                        <div class="row g-3">
                            <div class="col-lg-12 col-xl-12 col-md-8 mx-auto">
                                <div class="form-floating">
                                    <input type="text" name="login" class="form-control bg-transparent border border-white" id="loginInput" placeholder="@lang('words.login')" value="{{ old('login') }}">
                                    <label for="name">@lang('words.login')</label>
                                </div>
                            </div>
                            <div class="col-lg-12 col-xl-12 col-md-8 mx-auto">
                                <div class="form-floating">
                                    <input type="password" name="password" class="form-control bg-transparent border border-white" id="passwordInput" placeholder="@lang('words.password')">
                                    <label for="phone">@lang('words.password')</label>
                                </div>
                            </div>

                            <div class="text-end mt-3">
                                <p class="question">
                                    @lang('words.not_registered')
                                    <a href="{{ route('auth.register') }}" class="text-white text-decoration-underline">@lang('words.register')</a>.
                                </p>
                            </div>

                            <div class="col-lg-12 col-xl-12 col-md-8 mx-auto">
                                <div class="d-flex gap-2 align-items-center">
                                    <button type="submit" class="btn btn-light text-primary w-100 py-3">@lang('words.login_btn')</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.addEventListener('pageshow', function() {
                const submitBtn = document.querySelector('button[type="submit"]');
                if (submitBtn) {
                    submitBtn.innerHTML = '@lang("words.login_btn")';
