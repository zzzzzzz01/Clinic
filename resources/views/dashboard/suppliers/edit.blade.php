        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    @lang('words.edit_supplier') ({{ $supplier->name_uz }})
                </li>
            </ol>
        </nav>
        ...
        <div class="search-wrapper">
            <div class="search-card">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h4 class="mb-md-0">@lang('words.edit_supplier')</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-grid">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_uz" value="{{ old('name_uz', $supplier->name_uz) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_ru" value="{{ old('name_ru', $supplier->name_ru) }}"
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_en" value="{{ old('name_en', $supplier->name_en) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="type_uz" value="{{ old('type_uz', $supplier->type_uz) }}"
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="type_ru" value="{{ old('type_ru', $supplier->type_ru) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="type_en" value="{{ old('type_en', $supplier->type_en) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description_uz" rows="3"
                                placeholder="@lang('words.supplier_description_uz_placeholder')">{{ old('description_uz', $supplier->description_uz) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description_ru" rows="3"
                                placeholder="@lang('words.supplier_description_ru_placeholder')">{{ old('description_ru', $supplier->description_ru) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description_en" rows="3"
                                placeholder="@lang('words.supplier_description_en_placeholder')">{{ old('description_en', $supplier->description_en) }}</textarea>
                    ...
                    <div class="form-grid">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" name="phone" value="{{ old('phone', $supplier->phone) }}"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="is_active">
                                    <option value="1" {{ old('is_active', $supplier->is_active) == 1 ? 'selected' : '' }}>@lang('words.active')</option>
                                    <option value="0" {{ old('is_active', $supplier->is_active) == 0 ? 'selected' : '' }}>@lang('words.inactive')</option>
                                </select>
                                @error('is_active')
                                    <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                @enderror
