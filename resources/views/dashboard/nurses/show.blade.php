    ...
    <div class="container">
        ...
        <div class="print-content">
                ...
                <div class="nurse-main-content">
                    ...
                    <div class="info-sections">
                        ...
                        <div class="info-section">
                            ...
                            <div class="info-grid">
                                <div class="info-row">
                                    <div class="info-label"><i class="fas fa-stethoscope"></i> @lang('words.specialization'):</div>
                                ...
                                <div class="info-row">
                                    <div class="info-label"><i class="fas fa-building"></i> @lang('words.department'):</div>
                                    <div class="info-value">{{ $fd->department_name ?? '-' }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="info-label"><i class="fas fa-door-closed"></i> @lang('words.room_number'):</div>
                                    <div class="info-value">{{ $fd->room_number ?? '-' }}</div>
                                </div>
                                <div class="info-row">
                        ...
                        <div class="info-section">
                            ...
                            <div class="info-grid">
                                <div class="info-row">
                                    <div class="info-label"><i class="fas fa-university"></i> @lang('words.university'):</div>
                                    <div class="info-value">{{ $fd->education_university ?? '-' }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="info-label"><i class="fas fa-book"></i> @lang('words.education_specialization'):</div>
                                    <div class="info-value">{{ $fd->education_specialization ?? '-' }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="info-label"><i class="fas fa-layer-group"></i> @lang('words.education_level'):</div>
                                    <div class="info-value">{{ $fd->education_level ?? '-' }}</div>
                                </div>
                                <div class="info-row">
                                    <div class="info-label"><i class="fas fa-calendar-check"></i> @lang('words.graduation_date'):</div>
                                    <div class="info-value">{{ $fd->graduation_date ?? '-' }}</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="print-view">
                <h1 class="print-title">@lang('words.nurse_information')</h1>
                
                <table class="nurse-info-table">
                    ...
                    <tr><th>@lang('words.experience')</th><td>{{ $fd->experience_years }} @lang('words.years')</td></td>
                    <tr><th>@lang('words.department')</th><td>{{ $fd->department_name ?? '-' }}</td></tr>
                    <tr><th>@lang('words.room_number')</th><td>{{ $fd->room_number ?? '-' }}</td></tr>
