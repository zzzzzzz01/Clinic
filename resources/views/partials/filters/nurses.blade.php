<!-- Nurse filter -->
<div class="filter-panel" id="nurseFilterPanel">
    <div class="filter-panel-header">
        <h3><i class="fas fa-filter" style="color: #00BFFF;"></i> @lang('words.filters')</h3>
        <button class="filter-close-btn" id="nurseFilterCloseBtn">
            <i class="fas fa-times"></i>
        </button>
    </div>
    
    <div class="filter-panel-body">
        <form id="nurseFilterForm" method="GET" action="{{ url()->current() }}">
            <div class="filter-section">
                ...
                <div class="search-wrapper">
                    ...
                    <input type="text" class="modern-input" name="search" id="nurseSearchInput" placeholder="@lang('words.search_by_name_phone')" value="{{ request('search') }}">
                    <button type="button" class="clear-search" id="nurseClearSearch" style="display: {{ request('search') ? 'block' : 'none' }};">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
            </div>
            
            <!-- Holati - 2 tadan yonma-yon -->
            <div class="filter-section">
                <label class="filter-label">
            ...
            <div class="filter-section">
                ...
                <div class="modern-select">
                    <select name="department" id="nurseDepartmentSelect">
            ...
            <div class="filter-section">
                ...
                <div class="date-range">
                    <div class="date-input-group">
                        ...
                        <input type="date" class="modern-date-input" name="date_from" id="nurseStartDate" value="{{ request('date_from') }}" placeholder="@lang('words.from')">
                    </div>
                    <span class="date-separator">—</span>
                    <div class="date-input-group">
                        <i class="fas fa-calendar-day"></i>
                        <input type="date" class="modern-date-input" name="date_to" id="nurseEndDate" value="{{ request('date_to') }}" placeholder="@lang('words.to')">
                    </div>
                </div>
            </div>
            
            <div class="filter-actions">
                <button type="button" class="btn-clear" id="nurseResetFilters">
                    <i class="fas fa-redo-alt"></i>
                    @lang('words.clear')
                </button>
                <button type="submit" class="btn-apply" id="nurseApplyFilters">
...
<div class="filter-overlay" id="nurseFilterOverlay"></div>